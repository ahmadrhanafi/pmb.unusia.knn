...
<td>:<td><?php echo md5($username);?></td>
</tr>
...
<td>
<td>
<td colspan="2"><a href="?mnu=profil2"><input name="Batal" type="button" class="btn btn-primary btn-sm" id="Batal" value="Update Profil" /></a>
